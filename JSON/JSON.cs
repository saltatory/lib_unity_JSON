...
namespace Mobilityware.JSON
{
    ...
    /// <summary>
    /// Singleton JSON parser that knows how to serialize Unity objects
    /// </summary>
	public class JSON : IJSON {
		...
		/// <summary>
		/// Converts a float to a double, needed as LitJson reads numbers as double, and unity uses floats
		/// </summary>
