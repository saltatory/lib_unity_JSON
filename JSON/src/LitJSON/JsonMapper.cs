    ...
    public partial class JsonMapper
    {
        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
            ...
            if (reader.Token == JsonToken.ArrayStart) {
                // Change instance type to List<object> if it is type object; we can assume 
                // this is what user wants since token is for a json array's start
                ...
                // Change instance type to Dictionary if of type object; we can assume 
                // this is what user wants since token is for a json object's (dictionary's) start
                if( inst_type.Equals (typeof(object)) )
                {
                ...
                while (true) {
                    ...
                    if (t_data.Properties.ContainsKey (property)) {
						...
						{
							Console.WriteLine("[JsonMapper] Argument Exception.");
						}
